...
export_path_g = "../biomedical_part1/"
...
#tf.app.flags.DEFINE_integer('max_epoch', 50,'maximum of training epochs')
...
tf.app.flags.DEFINE_float('learning_rate',0.005,'learning rate for nn')
...
def main(_):
	...
	instance_scope = np.load(export_path + 'train_instance_scope0.npy')
        instance_scope_path = np.load(export_path_g + 'train_instance_scope_path0.npy')
